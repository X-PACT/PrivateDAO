...
| Autonomous executor packet | [`docs/zerion-autonomous-executor.generated.md`](docs/zerion-autonomous-executor.generated.md) |
...
| Autonomous executor expansion | The repo now carries a canonical `PrivateDAO Autonomous Executor` adaptation path for the Zerion track: PrivateDAO stays the governance and privacy layer, while a Zerion CLI fork becomes the wallet and execution engine for proposal-approved real transactions. | [`docs/zerion-autonomous-executor.md`](docs/zerion-autonomous-executor.md), [`docs/investor-pitch-deck.md`](docs/investor-pitch-deck.md), [`docs/demo-video.md`](docs/demo-video.md) |
| Autonomous executor packet | The Zerion track adaptation now also ships as a machine-checked packet that binds the current live V3 Devnet proof, scoped-policy examples, technology mapping, and the honest boundary for what still remains to build in the Zerion fork itself. | [`docs/zerion-autonomous-executor.generated.md`](docs/zerion-autonomous-executor.generated.md), [`docs/test-wallet-live-proof-v3.generated.md`](docs/test-wallet-live-proof-v3.generated.md), [`docs/zerion-autonomous-executor.md`](docs/zerion-autonomous-executor.md) |
...
| Autonomous agent track | [`docs/zerion-autonomous-executor.md`](docs/zerion-autonomous-executor.md), [`docs/investor-pitch-deck.md`](docs/investor-pitch-deck.md), [`docs/demo-video.md`](docs/demo-video.md) |
| Autonomous agent packet | [`docs/zerion-autonomous-executor.generated.md`](docs/zerion-autonomous-executor.generated.md), [`docs/test-wallet-live-proof-v3.generated.md`](docs/test-wallet-live-proof-v3.generated.md) |
