...
const whyNow = [
  ...
  ["DAO treasury growth", "Treasury decisions now involve payroll, vendors, auctions, and multi-party approvals."],
...
const progress = [
  ...
  ["Live product lines", "Payroll, treasury, governance, auctions, and verification are direct customer workflows."],
  ["Agent Exchange", "A machine-ready marketplace for discovery, paid services, receipts, and agent-to-agent work."],
  ["PDAO Worlds", "A consumer game and acquisition layer that makes privacy, proof, and coordination memorable."],
  ["Proof continuity", "Public verification links connect private work to an outcome a reviewer can check."],
] as const;
...
const commercialPath = [
  ...
  ["$2,500 fixed pilot", "Prove one governance, treasury, payroll, auction, or verification workflow over four weeks."],
...
const collaborationPath = [
  ["Design partners", "DAOs, protocol teams, finance operators, and organizations that want to prove one sensitive workflow."],
    ...
    >
      ...
      <section className="rounded-[28px] border border-white/10 bg-white/[0.035] p-4">
        <video
          ...
          controls
          preload="metadata"
          src="/videos/privatedao-investor-overview.mp4"
        />
      </section>
