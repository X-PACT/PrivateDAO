...
const workflows = [
  ["Credit decision verification", "Connect earnings data, apply private policy, issue a limit, and publish proof without exposing customer data."],
  ["Grant review", "Assign reviewers, preserve independent scoring, approve an award, and publish a proof-linked outcome."],
  ["Treasury approval", "Coordinate a sensitive treasury request, route authority, approve execution, and export the receipt."],
  ["Private governance", "Run proposal, review, private voting, reveal, and verification with a guided operator flow."],
...
const deliverables = [
  "One configured commercial workflow",
  "Wallet onboarding or organization operator flow",
...
export default function PilotsPage() {
  return (
    <OperationsShell
      ...
      description="PrivateDAO pilots start with a real operational pain, not a broad platform rollout. Select one workflow, run it with your sample data or redacted JSON, measure the result, and decide whether repeated use is justified."
    ...
    >
      ...
      <section className="rounded-[28px] border border-white/10 bg-white/[0.035] p-5 sm:p-6">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a href="mailto:business@privatedao.org?subject=PrivateDAO%20Pilot" className={cn(buttonVariants({ size: "sm" }))}>
            Request a pilot
          ...
          <Link href="/pilots/credit-decision-verification" className={cn(buttonVariants({ size: "sm", variant: "secondary" }))}>
            Run credit proof
          </Link>
