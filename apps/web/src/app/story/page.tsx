...
export const metadata: Metadata = buildRouteMetadata({
  ...
  path: "/story",
  keywords: ["story video", "product video", "governance guide", "demo video"],
});
...
export default function StoryPage() {
  return (
    <OperationsShell
      ...
      description="This route hosts the complete product story for judges, buyers, operators, and community supporters. It explains how PrivateDAO turns advanced governance, treasury rails, cryptography, and runtime clarity into a usable product."
      badges={[
