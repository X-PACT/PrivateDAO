...
const SUPPLY_RAW = "999999998078172";
...
const DECK_URL = "https://privatedao.org/investors/";
...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "token:circulating-supply": "965570919",
...
const tokenJsonLd = {
  ...
  additionalProperty: [
    ...
    { "@type": "PropertyValue", name: "circulatingSupply", value: "965570919" },
...
const links = [
  ...
  ["Verified PDAO holder community", VERIFIED_PDAO_HOLDERS_URL],
  ["Discord", DISCORD_URL],
  ["GitHub", GITHUB_URL],
...
const tokenomics = [
  ["Community circulation", "965,570,919 PDAO", "≈ 96.56% accessible through the live market and community distribution surface."],
