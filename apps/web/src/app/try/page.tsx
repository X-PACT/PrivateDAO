...
export const metadata: Metadata = buildRouteMetadata({
  ...
  path: "/try",
  keywords: ["try private dao", "private workflow", "private voting", "reveal proof"],
});

const steps = [
  ["1", "Connect wallet", "Connect safely. No seed phrase and no custodial account."],
  ...
  return (
    <OperationsShell
      ...
      badges={[
        ...
        { label: "Guided workflow", variant: "cyan" },
