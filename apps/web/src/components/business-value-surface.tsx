...
const outcomes = [
  {
    ...
    value: "Keep vote momentum, reviewer opinions, treasury intent, and operational context private until disclosure is useful.",
  },
  {
...
const audiences = [
  ...
  ["Operating teams", "Route reviews, approvals, and execution records without rebuilding the process from scattered tools."],
] as const;
      ...
      {!compact ? (
        <>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link href="/pilots" className={cn(buttonVariants({ size: "sm", variant: "secondary" }))}>
              Request Pilot
            </Link>
