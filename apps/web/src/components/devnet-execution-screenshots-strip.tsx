  ...
  return (
    <div className="rounded-[28px] border border-cyan-300/16 bg-cyan-300/[0.08] p-6">
      ...
      <div className="mt-3 max-w-3xl text-sm leading-7 text-white/68">
        Open the current Testnet lifecycle packet with real Solscan signatures, treasury deltas, and the agentic
        micropayment rail. This helps a non-technical reviewer verify that the product is already creating
