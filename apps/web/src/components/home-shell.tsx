              ...
              <div className="max-w-3xl rounded-[26px] border border-cyan-300/18 bg-cyan-300/[0.08] p-5">
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-3">
                  {[
                    ...
                    ["Private room", "Payroll, incidents, partnerships, and reviewer rooms."],
      ...
      <section className="mt-8 w-full">
        ...
        <div className="mt-6 grid gap-4 xl:grid-cols-3">
          ...
          <div className="rounded-[28px] border border-cyan-300/14 bg-[linear-gradient(180deg,rgba(8,18,28,0.96),rgba(8,11,20,0.99))] p-6">
            ...
            <div className="mt-3 text-xl font-semibold text-white">DAOs, councils, finance teams, and confidential payout operations</div>
            <p className="mt-3 text-sm leading-7 text-white/62">
              The strongest current use cases are easy to explain: private treasury approvals, protocol operating councils, payroll, auctions, verification, and payout workflows where privacy and execution discipline must stay together.
            </p>
          </div>
