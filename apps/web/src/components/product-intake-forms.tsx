...
const intakePresets: IntakePreset[] = [
  {
    ...
    handoff: {
      ...
      narrative: "Move the request into Engage first, then keep Services and Govern close so the commercial story stays tied to real product operation.",
  ...
  },
  {
    ...
    handoff: {
      ...
      narrative: "Take the request into Services and Govern so the payments story remains anchored to governance-backed execution, not a generic checkout narrative.",
      primaryAction: { label: "Open payments services", href: "/services" },
      evidenceAction: { label: "Open govern flow", href: "/govern" },
    },
    routeSet: [
      { label: "Services", href: "/services" },
      { label: "Govern", href: "/govern" },
  ...
  },
  {
    ...
    handoff: {
      ...
      evidenceAction: { label: "Join Discord", href: "https://discord.gg/GjJykUtTTt" },
    },
    routeSet: [
...
const fundingProfileOverrides: Record<string, FundingProfileOverride> = {
  "treasury-top-up": {
    ...
    handoff: {
      ...
      priority: "Commercial now",
      narrative:
        "Treat this as treasury capitalization, not a generic payment. Keep Services and Govern close so the sender sees how capital strengthens live governance, diagnostics, and operator continuity.",
  ...
  "agentic-micropayment-rail": {
    ...
    handoff: {
      ...
      narrative:
        "Treat this as a policy-bound execution rail. Keep Services, Govern, Proof, and Analytics in the same loop so the visitor can see that batched micropayments are triggered by DAO policy and verified on Testnet.",
  ...
  "vendor-payout": {
    ...
    handoff: {
      ...
      narrative:
        "This is an operator-grade treasury action. Keep Govern and Diagnostics in the loop so beneficiary validation, execution health, and payout evidence remain explicit.",
      primaryAction: { label: "Open govern flow", href: "/govern" },
      evidenceAction: { label: "Open diagnostics", href: "/diagnostics" },
    },
    routeSet: [
      { label: "Govern", href: "/govern" },
  ...
  "contributor-payout": {
    ...
    handoff: {
      ...
      primaryAction: { label: "Open govern flow", href: "/govern" },
      evidenceAction: { label: "Open trust", href: "/trust" },
    },
    routeSet: [
      { label: "Govern", href: "/govern" },
      { label: "Trust", href: "/trust" },
