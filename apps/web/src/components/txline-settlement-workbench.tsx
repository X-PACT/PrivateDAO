        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <div>
            ...
            <div className="mt-3 grid gap-3 rounded-2xl border border-amber-300/15 bg-amber-300/[0.07] p-4 text-sm leading-6 text-white/68 sm:grid-cols-3">
              ...
              <div>
                <div className="text-[11px] uppercase tracking-[0.2em] text-amber-100/70">Free tier path</div>
                <div className="mt-1 font-semibold text-white">Guest JWT -&gt; free subscription -&gt; activated API token</div>
              </div>
              <div>
                <div className="text-[11px] uppercase tracking-[0.2em] text-amber-100/70">Receipt mode</div>
                <div className="mt-1 font-semibold text-white">Solana Mainnet memo receipt</div>
              </div>
            </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="grid gap-3">
            <div className="grid gap-2 rounded-2xl border border-white/10 bg-black/20 p-4 text-sm leading-6 text-white/64">
              ...
              <div>2. Sign the free World Cup subscription on-chain with wallet 4Mm5YTRbJuyA8NcWM85wTnx6ZQMXNph2DSnzCCKLhsMD.</div>
