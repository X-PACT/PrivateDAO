...
const curatedDocuments: CuratedDocument[] = [
  ...
  },
  {
    ...
    title: "Squads Devnet Multisig Ceremony",
    category: "Operations",
    summary: "Exact Devnet-first operator sequence for creating a Squads multisig, recording evidence, and transferring upgrade authority once the real signer is present.",
    audience: "Operators, auditors, judges, launch leads",
    boundary: "This is the shortest honest ceremony path; it does not claim that the authority transfer has already happened.",
