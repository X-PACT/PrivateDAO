...
const curatedDocuments: CuratedDocument[] = [
  ...
  {
    slug: "private-dao-repositioning-strategy-2026-06-17",
    title: "PrivateDAO Repositioning Strategy",
    category: "Strategy",
    summary:
    ...
    docPath: "docs/private-dao-repositioning-strategy-2026-06-17.md",
    rawHref: `${repositoryBlobBase}/docs/private-dao-repositioning-strategy-2026-06-17.md`,
  },
  {
    slug: "commercial-readiness-implementation-2026-06-17",
    title: "Commercial Readiness Implementation",
    category: "Commercial",
    summary:
      "Implementation document for PrivateDAO's purchasable product model: crypto subscription checkout, treasury-address configuration, 14-day trials, license records, organization activation, plans, and advanced financial module boundaries.",
    audience: "Customers, pilot partners, investors, judges, operators, maintainers",
    boundary:
      "Commercial implementation document only; crypto payments activate subscriptions and pilots, but PrivateDAO remains positioned as private governance, treasury coordination, reviews and approvals, intelligence, workflow, and proof infrastructure rather than a payments platform.",
    docPath: "docs/commercial-readiness-implementation-2026-06-17.md",
    rawHref: `${repositoryBlobBase}/docs/commercial-readiness-implementation-2026-06-17.md`,
  },
  {
    slug: "proof-workflows-commercial-product-2026-06-17",
    title: "Proof Workflows Commercial Product",
    category: "Commercial",
    summary:
      "Product implementation document for Proof Workflows, a standalone PrivateDAO commercial product line that proves internal business process integrity without exposing underlying data, rules, thresholds, documents, reviewer notes, or methodology.",
    audience: "Fintech companies, lenders, accelerators, grant programs, gaming organizations, foundations, enterprises, investors, judges",
    boundary:
      "Product implementation document only; Proof Workflows is explicitly not positioned as a DAO feature or voting feature, and it does not reveal private workflow data in the public verification portal.",
    docPath: "docs/proof-workflows-commercial-product-2026-06-17.md",
    rawHref: `${repositoryBlobBase}/docs/proof-workflows-commercial-product-2026-06-17.md`,
  },
  {
    slug: "blind-policy-enterprise-readiness",
    title: "Blind Policy Enterprise Readiness",
    category: "Security",
    summary:
    ...
    docPath: "docs/blind-policy-enterprise-readiness.md",
    rawHref: `${repositoryBlobBase}/docs/blind-policy-enterprise-readiness.md`,
  },
  {
    slug: "txline-settlement-architecture",
    title: "TxLINE Match Settlement Architecture",
    category: "Settlement",
    summary:
    ...
    docPath: "docs/txline-settlement-architecture.md",
    rawHref: `${repositoryBlobBase}/docs/txline-settlement-architecture.md`,
  },
  {
