...
const curatedDocuments: CuratedDocument[] = [
  ...
  },
  {
    ...
    category: "Strategy",
    summary: "Reviewer-safe packet for Dune and RPC infrastructure corridors showing how runtime evidence, diagnostics, analytics, and hosted reads already map to real product value.",
    audience: "Judges, grant reviewers, infra reviewers, operators",
    boundary: "Telemetry packet only; it does not claim a Dune-native dashboard or production mainnet data plane.",
  ...
  },
  {
    ...
    category: "Strategy",
    summary: "Reviewer-safe packet for private payout and treasury motion corridors showing how confidentiality, governance, and trust surfaces already connect on Devnet.",
    audience: "Judges, grant reviewers, buyers, operators",
    boundary: "Evidence packet only; it does not claim mainnet-ready real-funds payout or closed external audit and receipt blockers.",
  ...
  },
  {
    ...
    category: "Strategy",
    summary: "Capital-facing packet tying product, services, trust, and mainnet blocker truth together for accelerator and grant reviewers.",
    audience: "Grant reviewers, accelerator reviewers, founders, operators",
    boundary: "Capital-readiness packet only; it does not claim that mainnet, custody, audit, or monitoring blockers are already closed.",
  ...
  },
  {
    ...
    category: "Grants",
    summary: "Application-ready packet for accelerator reviewers showing why PrivateDAO already behaves like a company-in-formation with clear capital use and a disciplined path to mainnet readiness.",
    audience: "Accelerator reviewers, grant reviewers, founders, operators",
    boundary: "Application packet only; it does not claim finished audit, custody closure, monitoring closure, or mainnet real-funds readiness.",
  ...
  },
  {
    ...
    category: "Grants",
    summary: "Fast scorecard for funders showing what is shipped now, what capital directly unlocks, and which remaining gates are still external-only before mainnet release.",
    audience: "Grant reviewers, accelerator reviewers, operators, founders",
    boundary: "Readiness scorecard only; it clarifies the current posture without overstating blocker closure or mainnet readiness.",
