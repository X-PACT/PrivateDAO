...
const englishCopy: LocalizedCopy = {
  ...
  statusBanner: {
    ...
    title: "Testnet transition is in progress while core development continues through April 30, 2026.",
    body: "PrivateDAO remains Devnet-proven today while the Anchor workspace, RPCFast-backed infrastructure, IDLs, and frontend bindings are being prepared for the next Testnet rehearsal. Some routes may change while verification, billing rehearsal, localization, and wallet flows are being tightened. If something looks inconsistent, retry in a few minutes and open the trust or community route for the latest operating truth.",
    retry: "Retry in a few minutes",
    until: "Testnet rehearsal target: hours, not a mainnet claim yet",
...
export const localizedCopy: Record<SupportedLocale, LocalizedCopy> = {
  ...
  ar: {
    ...
    statusBanner: {
      ...
      title: "الانتقال إلى Testnet جارٍ الآن مع استمرار التطوير الأساسي حتى 30 أبريل 2026.",
      body: "PrivateDAO مثبت على Devnet اليوم، ويتم الآن تجهيز Workspace الخاص بـ Anchor والبنية المدعومة من RPCFast والـ IDLs وربط الواجهة لمرحلة Testnet التالية. قد تتغير بعض المسارات بينما نغلق التحقق والفوترة التجريبية والترجمة ومسارات المحافظ. إذا ظهر تعارض أو تعطل مؤقت، أعد المحاولة بعد دقائق وافتح مسار الثقة أو المجتمع لمعرفة الحقيقة التشغيلية الأحدث.",
      retry: "أعد المحاولة بعد دقائق",
      until: "هدف بروفة Testnet: خلال ساعات، وليس ادعاء Mainnet بعد",
