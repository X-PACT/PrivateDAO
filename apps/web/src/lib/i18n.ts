...
export const localizedCopy: Record<SupportedLocale, LocalizedCopy> = {
  ...
  ru: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO уже работает в Solana Testnet и развивается как операционная система для приватных treasury- и market-операций.",
      body: "Live-маршрут в Testnet уже доступен: lifecycle управления, проверка treasury delta, wallet-first flow и публичная proof continuity работают. Сейчас продукт расширяется через custody proof, billing rehearsal, локализацию, конфиденциальные settlement-рейлы и reviewer-grade operating surfaces.",
      retry: "Повторите через несколько минут",
      until: "Базовый lifecycle Testnet завершён; mainnet пока не заявляется",
  ...
  uk: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO вже працює в Solana Testnet і розвивається як операційна система для приватних treasury- та market-операцій.",
      body: "Live-маршрут у Testnet уже активний: lifecycle керування, перевірка treasury delta, wallet-first flow і публічна proof continuity вже працюють. Зараз продукт розширюється через custody proof, billing rehearsal, локалізацію, конфіденційні settlement-рейли та reviewer-grade operating surfaces.",
      retry: "Спробуйте ще раз за кілька хвилин",
      until: "Базовий lifecycle Testnet завершено; mainnet поки не заявляється",
  ...
  pl: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO działa już w Solana Testnet i rozwija się jako system operacyjny dla prywatnych operacji treasury i market.",
      body: "Ścieżka live na Testnet jest już aktywna: lifecycle governance, weryfikacja treasury delta, wallet-first flow i publiczna proof continuity są gotowe. Produkt rozwija się dalej przez custody proof, billing rehearsal, lokalizację, poufne settlement rails i reviewer-grade operating surfaces.",
      retry: "Spróbuj ponownie za kilka minut",
      until: "Podstawowy lifecycle Testnet jest ukończony; mainnet nie jest jeszcze deklarowany",
  ...
  hi: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO अब Solana Testnet पर लाइव है और private treasury व market execution के लिए एक operating system के रूप में विकसित हो रहा है।",
      body: "Live Testnet path पहले से सक्रिय है: governance lifecycle execution, treasury delta verification, wallet-first operation flow और public proof continuity मौजूद हैं। अब उत्पाद custody proof, billing rehearsal, localization, confidential settlement rails और reviewer-grade operating surfaces के साथ लगातार आगे बढ़ रहा है।",
      retry: "कुछ मिनट बाद फिर प्रयास करें",
      until: "मानक Testnet lifecycle पूरा है; mainnet का दावा अभी नहीं किया गया है",
  ...
  ko: {
    ...
    statusBanner: {
      label: "라이브 개발 공지",
      title: "PrivateDAO는 이미 Solana Testnet에서 동작 중이며, private treasury 및 market execution을 위한 운영 체계로 계속 발전하고 있습니다.",
      body: "Live Testnet 경로는 이미 활성화되어 있습니다. governance lifecycle execution, treasury delta verification, wallet-first flow, public proof continuity가 마련되어 있습니다. 이제 제품은 custody proof, billing rehearsal, localization, confidential settlement rails, reviewer-grade operating surfaces까지 계속 확장되고 있습니다.",
      retry: "몇 분 후 다시 시도하세요",
      until: "기본 Testnet lifecycle은 완료되었으며, mainnet은 아직 주장하지 않습니다",
      openTrust: "Trust 열기",
  ...
  es: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO ya está activo en Solana Testnet y sigue avanzando como un sistema operativo para operaciones privadas de tesorería y mercado.",
      body: "La ruta live en Testnet ya está activa: ejecución del lifecycle de governance, verificación de treasury delta, flujo wallet-first y continuidad pública de proof ya existen. Ahora el producto sigue creciendo con custody proof, billing rehearsal, localización, confidential settlement rails y reviewer-grade operating surfaces.",
      retry: "Vuelve a intentarlo en unos minutos",
      until: "El lifecycle estándar de Testnet está completo; aún no se reclama mainnet",
  ...
  it: {
    ...
    statusBanner: {
      ...
      title: "PrivateDAO è già attivo su Solana Testnet e continua ad evolversi come sistema operativo per operazioni private di treasury e di mercato.",
      body: "Il percorso live su Testnet è già attivo: execution del lifecycle di governance, verifica della treasury delta, wallet-first flow e proof continuity pubblica sono già presenti. Ora il prodotto continua ad espandersi con custody proof, billing rehearsal, localizzazione, confidential settlement rails e reviewer-grade operating surfaces.",
      retry: "Riprova tra qualche minuto",
      until: "Il lifecycle standard su Testnet è completo; mainnet non viene ancora dichiarata",
