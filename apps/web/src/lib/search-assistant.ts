...
const assistantIntents: AssistantIntent[] = [
  ...
  },
  {
    ...
    summary:
      "Open the trust route when the question is about privacy, evidence, security boundaries, or how PrivateDAO protects important decisions.",
  ...
  },
  {
    ...
    relatedRoutes: [
      ...
      { label: "Services", href: "/services" },
      { label: "Trust and proof", href: "/trust" },
    ],
