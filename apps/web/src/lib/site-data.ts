...
export const VERIFIED_PDAO_HOLDERS_URL = "https://telegram.me/collablandbot?start=VFBDI1RFTCNDT01NIy0xMDAzOTg4OTE3NjYx";

export const communityLinks = [
  {
    title: "Verified PDAO holders",
    href: VERIFIED_PDAO_HOLDERS_URL,
    summary: "Private community for verified PDAO holders: early access, updates, proposals, feedback, and discussion.",
...
export const treasuryRows = [
  ...
  {
    asset: "Operating reserve",
    allocation: "Policy-bound",
    value: "Review before release",
    policy: "Approved spending rules with a preserved decision record",
    runtime: "Ready for review",
  },
];
