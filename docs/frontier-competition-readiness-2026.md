...
- It lists where PrivateDAO is already strong.
...
- Highest-value move:
  - Treat this as a secondary target unless a dedicated assistant surface is added truthfully.

## Product corridors to foreground
...
When adapting the project for any track:
