...
2. inspect the transaction in:
   - [live-proof.md](docs/live-proof.md)-style format
   - [test-wallet-live-proof-v3.generated.md](docs/test-wallet-live-proof-v3.generated.md) when the stricter additive path is relevant
   - Solscan
