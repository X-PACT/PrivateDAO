...
- project: `PrivateDAO`
- generated at: `2026-04-15T15:16:57.049Z`
- status: `pending-source-receipt-closure`
- closure requirements: `0/4`
...
- Residual trust model | pending | evidence: explicit written boundary when source receipts are unavailable
- Reviewer proof route | pending | evidence: reviewer-visible publication path for receipt evidence
