# Submission Refresh - Testnet Proven
...
- Mainnet is the next release stage, not a completed claim.
...
| --- | --- | --- |
| Superteam Poland | Testnet-proven governance and treasury infrastructure | `https://privatedao.org/start/` |
| Not Your Regular Bounty | Governed Jupiter treasury route and Testnet lifecycle proof | `https://privatedao.org/services/#jupiter-treasury-route` |
