...
export const EVM_NETWORK_CONFIGS: readonly EvmNetworkConfig[] = [
  ...
  { network: "tempo-testnet", label: "Tempo Testnet", environment: "testnet", chainId: "42431", nativeAsset: "USD", rpcUrlEnv: "PDAO_EVM_TEMPO_TESTNET_RPC_URL", explorerBaseUrl: "https://explore.tempo.xyz/", mainnetEnabled: false },
