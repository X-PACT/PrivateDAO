...
function main() {
    const source = readJson("docs/competitive/source.json");
    ...
    fs_1.default.writeFileSync(path_1.default.resolve("docs/competitive/analysis.generated.json"), JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(path_1.default.resolve("docs/competitive/analysis.generated.md"), buildMarkdown(payload));
...
function sanitizeArchiveTitle(title) {
