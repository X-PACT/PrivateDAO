...
function main() {
    ...
    const outPath = path_1.default.resolve("docs/cryptographic-manifest.generated.json");
    fs_1.default.writeFileSync(outPath, JSON.stringify(manifest, null, 2) + "\n");
    console.log(`Wrote cryptographic manifest: ${path_1.default.relative(process.cwd(), outPath)}`);
}
