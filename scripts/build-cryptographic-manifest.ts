...
const MANIFEST_FILES = [
  ...
  "docs/zk-enforced-runtime-templates/README.md",
  "docs/zk-enforced-runtime-templates/phantom-desktop-zk-enforced.json",
  "docs/zk-enforced-runtime-templates/solflare-desktop-zk-enforced.json",
  "docs/zk-enforced-runtime-templates/backpack-desktop-zk-enforced.json",
  "docs/zk-enforced-runtime-templates/glow-desktop-zk-enforced.json",
  "docs/zk-enforced-runtime-templates/android-runtime-zk-enforced.json",
