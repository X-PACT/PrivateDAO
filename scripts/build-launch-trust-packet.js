...
function main() {
    const multisig = readJson("docs/multisig-setup-intake.json");
    ...
    const canonicalCustody = readJson("docs/canonical-custody-proof.generated.json");
    ...
    const payload = {
        ...
        audit: {
            ...
            pendingAction: blockers.blockers.find((entry) => entry.id === "external-audit-completion")?.nextAction ??
    ...
    fs_1.default.writeFileSync(path_1.default.resolve("docs/launch-trust-packet.generated.json"), JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(path_1.default.resolve("docs/launch-trust-packet.generated.md"), buildMarkdown(payload));
