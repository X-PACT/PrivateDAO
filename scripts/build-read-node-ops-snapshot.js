...
async function main() {
    ...
    const jsonPath = path_1.default.resolve("docs/read-node/ops.generated.json");
    const mdPath = path_1.default.resolve("docs/read-node/ops.generated.md");
    fs_1.default.writeFileSync(jsonPath, JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(mdPath, `# Read Node Ops Snapshot
...
`);
    console.log(`Wrote read-node ops snapshot: ${path_1.default.relative(process.cwd(), jsonPath)}`);
}
main().catch((error) => {
