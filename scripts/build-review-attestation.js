...
function main() {
    ...
    const outPath = path_1.default.resolve("docs/review-attestation.generated.json");
    fs_1.default.writeFileSync(outPath, JSON.stringify(attestation, null, 2) + "\n");
    console.log(`Wrote review attestation: ${path_1.default.relative(process.cwd(), outPath)}`);
}
