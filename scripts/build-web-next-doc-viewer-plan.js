...
function main() {
    ...
    fs_1.default.writeFileSync(path_1.default.resolve("docs/web-next-doc-viewer-plan.generated.json"), JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(path_1.default.resolve("docs/web-next-doc-viewer-plan.generated.md"), buildMarkdown(payload));
