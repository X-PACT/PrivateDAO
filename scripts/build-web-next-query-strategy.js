...
function main() {
    ...
    fs_1.default.writeFileSync(path_1.default.resolve("docs/web-next-query-strategy.generated.json"), JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(path_1.default.resolve("docs/web-next-query-strategy.generated.md"), buildMarkdown(payload));
