...
function main() {
    const source = readJson("docs/zk/enforced-runtime-captures.json");
    ...
    const payload = {
        ...
        status: summary.pendingTargets.length === 0 && summary.finalizeSuccessCount > 0
            ? "zk-enforced-runtime-captured"
            : "pending-zk-enforced-capture",
    };
    fs_1.default.writeFileSync(path_1.default.resolve("docs/zk/enforced-runtime.generated.json"), JSON.stringify(payload, null, 2) + "\n");
    fs_1.default.writeFileSync(path_1.default.resolve("docs/zk/enforced-runtime.generated.md"), buildMarkdown(payload));
