...
ffmpeg -y -f lavfi -i "color=c=#06111A:s=1280x720" -i "$ASSETS_DIR/logo.png" \
  -filter_complex "[1:v]scale=200:200[logo];[0:v]drawbox=x=0:y=0:w=1280:h=720:color=0x06111A:t=fill,drawbox=x=68:y=86:w=1144:h=548:color=0x0B1722@0.90:t=fill,drawtext=fontfile=$FONT_BOLD:text='PrivateDAO':fontsize=84:fontcolor=white:x=100:y=170,drawtext=fontfile=$FONT_REG:text='Create DAO. Submit proposal. Private vote. Execute treasury.':fontsize=32:fontcolor=0xDCE8F6:x=104:y=264,drawtext=fontfile=$FONT_BOLD:text='Live product:':fontsize=28:fontcolor=0xA9F5FF:x=104:y=386,drawtext=fontfile=$FONT_REG:text='x-pact.github.io/PrivateDAO/':fontsize=28:fontcolor=white:x=304:y=386,drawtext=fontfile=$FONT_BOLD:text='Repository:':fontsize=28:fontcolor=0xFFE48A:x=104:y=444,drawtext=fontfile=$FONT_REG:text='github.com/X-PACT/PrivateDAO':fontsize=28:fontcolor=white:x=286:y=444,drawtext=fontfile=$FONT_REG:text='Frontier-ready, evidence-rich, and honest about launch blockers.':fontsize=30:fontcolor=0xFFF1B0:x=104:y=548[base];[base][logo]overlay=938:124" \
