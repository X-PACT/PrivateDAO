...
ffmpeg -y -f lavfi -i "color=c=#06111A:s=1280x720" -i "$ASSETS_DIR/logo.png" \
  -filter_complex "[1:v]scale=220:220[logo];[0:v]drawbox=x=0:y=0:w=1280:h=720:color=0x06111A:t=fill,drawbox=x=68:y=86:w=1144:h=548:color=0x0B1722@0.90:t=fill,drawbox=x=92:y=108:w=430:h=44:color=0x0E2733@0.96:t=fill,drawtext=fontfile=$FONT_BOLD:text='BUILD THE NEXT TRUST LAYER':fontsize=24:fontcolor=0xA9F5FF:x=112:y=116,drawtext=fontfile=$FONT_BOLD:text='PrivateDAO':fontsize=78:fontcolor=white:x=104:y=216,drawtext=fontfile=$FONT_REG:text='From private voting to confidential organizational operations on Solana.':fontsize=28:fontcolor=0xDCE8F6:x=106:y=286,drawtext=fontfile=$FONT_REG:text='The repo already proves governance, payouts, runtime evidence, and a credible mainnet path.':fontsize=28:fontcolor=0xDCE8F6:x=106:y=332,drawtext=fontfile=$FONT_BOLD:text='Why it matters:':fontsize=30:fontcolor=0xFFE48A:x=106:y=420,drawtext=fontfile=$FONT_REG:text='- private governance with real execution':fontsize=26:fontcolor=white:x=132:y=470,drawtext=fontfile=$FONT_REG:text='- confidential payroll, bonus, and REFHE flows':fontsize=26:fontcolor=white:x=132:y=512,drawtext=fontfile=$FONT_REG:text='- a credible infrastructure layer worth backing':fontsize=26:fontcolor=white:x=132:y=554,drawtext=fontfile=$FONT_REG:text='x-pact.github.io/PrivateDAO   ·   github.com/X-PACT/PrivateDAO':fontsize=24:fontcolor=0xA9F5FF:x=106:y=618[base];[base][logo]overlay=960:120" \
