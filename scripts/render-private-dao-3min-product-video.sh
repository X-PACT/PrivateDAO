...
create_scene "04" "Intelligence layer" "QVAC, GoldRush, Dune, and RPC quality before signing." "Local AI explains the operation." "GoldRush and Dune add wallet and transaction context." "The signer sees risk, counterparty posture, and privacy mode first." "0x38BDF8"
