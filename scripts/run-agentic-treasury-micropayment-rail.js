...
const micropayment_engine_1 = require("./lib/micropayment-engine");
async function main() {
    const args = (0, utils_1.parseArgs)();
    const report = await (0, micropayment_engine_1.runAgenticMicropaymentRail)({
        transferTarget: typeof args.transferTarget === "number"
            ? args.transferTarget
            : typeof args.count === "number"
                ? args.count
                : 50,
        targetCount: typeof args.targetCount === "number"
            ? args.targetCount
            : 10,
