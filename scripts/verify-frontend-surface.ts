...
function main() {
  ...
  const requiredFragments = [
    ...
    "Live Proof V3 + Pilot Program + Trust Package",
    "Live Proof V3 + Trust Package + Confidential Payments + Launch Trust Packet",
    "Live Proof V3 + Frontier Integrations + Launch Trust Packet + Pricing Model",
    "Live Proof V3 + Frontier Integrations + MagicBlock docs + Operational Evidence",
    "Judge View",
    "Buyer View",
    "Operator View",
    "openJudgeQuickView",
