...
function main() {
  ...
  const requiredFragments = [
    ...
    "Copy Executor Packet",
    "PrivateDAO Autonomous Executor",
    "Autonomous Executor Track Fit",
    "GOVERNANCE-CONTROLLED AGENT FLOW",
    "BOUNTY COMPLIANCE MATRIX",
    "Scoped policy:",
    "Real treasury execution:",
    "Zerion-routed execution:",
    "already proven on Devnet",
    "pending implementation in the Zerion fork",
    "POLICY BUNDLE",
    "Base-only chain lock",
    "30 minute expiry",
    "EXECUTION BOUNDARY",
    "Open Compliance Packet",
    "Autonomous executor packet copied.",
    "copyAutonomousExecutorPacket",
    "Service Catalog",
