...
function main() {
    const jsonPath = path_1.default.resolve("docs/frontier-integrations.generated.json");
    const mdPath = path_1.default.resolve("docs/frontier-integrations.generated.md");
