...
function main() {
    const json = JSON.parse(fs_1.default.readFileSync(path_1.default.resolve("docs/read-node/snapshot.generated.json"), "utf8"));
    const markdown = fs_1.default.readFileSync(path_1.default.resolve("docs/read-node/snapshot.generated.md"), "utf8");
    const frontendModule = fs_1.default.readFileSync(path_1.default.resolve("apps/web/src/lib/read-node-proposal-context.generated.ts"), "utf8");
