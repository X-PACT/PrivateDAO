...
function main() {
    const jsonPath = path_1.default.resolve("docs/reviewer-telemetry-packet.generated.json");
    const mdPath = path_1.default.resolve("docs/reviewer-telemetry-packet.generated.md");
